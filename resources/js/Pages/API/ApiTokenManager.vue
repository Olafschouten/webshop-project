  ...
  <div>
    ...
    <jet-dialog-modal :show="managingPermissionsFor" @close="managingPermissionsFor = null">
      ...
      <template #footer>
        ...
        <jet-button class="ml-2" @click.native="updateApiToken" :class="{ 'opacity-25': updateApiTokenForm.processing }"
    ...
    <jet-confirmation-modal :show="apiTokenBeingDeleted" @close="apiTokenBeingDeleted = null">
      ...
      <template #footer>
        ...
        <jet-danger-button class="ml-2" @click.native="deleteApiToken"
