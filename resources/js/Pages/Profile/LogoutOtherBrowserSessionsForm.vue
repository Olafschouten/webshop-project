  ...
  <jet-action-section>
    ...
    <template #content>
      <div class="max-w-xl text-sm text-gray-600">
        If necessary, you may logout of all of your other browser sessions across all of your devices. If you feel your
      ...
      <jet-dialog-modal :show="confirmingLogout" @close="confirmingLogout = false">
        ...
        <template #footer>
          ...
          <jet-button class="ml-2" @click.native="logoutOtherBrowserSessions" :class="{ 'opacity-25': form.processing }"
